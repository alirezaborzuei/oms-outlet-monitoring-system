...
import { resetAttachments } from '../../../lib/store/attachmentsSlice';
    ...
    <Layout>
      <AuthWrapper>
        <div className="max-w-4xl mx-auto px-4 py-8" style={{ direction: 'rtl' }}>
          <div className="mb-8">
            {visitInfo && (
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <h3 className="text-2xl font-semibold mb-6 text-right">اطلاعات بازدید</h3>
          ...
          {visitInfo && ((role === 'LDAPUser' && visitInfo.flow==='Supervisor')||(role === 'Specialist' && visitInfo.flow==='Specialist')) && (
 ...
 <Modal isOpen={isModalOpen} onClose={closeModal}>
  {selectedPhoto && (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
      <div className="relative w-full h-full p-8 bg-white overflow-auto">
      <button
          onClick={closeModal}
        ...
        <div className="flex justify-center items-center h-full">
          <Image
            ...
            alt="Selected"
            width={selectedPhoto.imageWidth || 1280}
            height={selectedPhoto.imageHeight || 720}
        ...
        <div className="mt-6 bg-white p-4 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-6">
           ...
           {/*  {selectedPhoto.flow === 'Draft' && (
              <div className="flex justify-center mt-6">
                <button
                  onClick={() => handleDelete(selectedPhoto.attachmentID)}
                  className="px-4 py-2 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-700"
                >
                  حذف تصویر
                </button>
              </div>
            ...
            {(selectedPhoto.flow === 'Supervisor' && role === 'Supervisor') || 
